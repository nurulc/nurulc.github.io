(function (global, factory) {
  ...
  function isReactNode(d) {
    if (!d || _typeof(d) !== 'object' || _typeof(window.React) === undefined || _typeof(window.ReactUI) === undefined) return false;
  ...
  function setNext(_ref) {
    ...
    var htmlStr = "<a href=\"".concat(back, "\">Back</a>&nbsp;<a href=\"").concat(prev, "\">").concat(prev, "</a>&nbsp;<a href=\"").concat(next, "\">").concat(next, "</a>");
  ...
  function addBackButton(link) {
    ...
    b.innerHTML = "<a class=\"ui labeled icon button large blue  back-button \" href=\"".concat(link, "\"><i class=\"left arrow icon\"></i>Back</button>");
