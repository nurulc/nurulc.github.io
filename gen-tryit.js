    ...
    return ("<a id=\"_tryit"+(i)+"\">&nbsp</a>\n"+
            "<div class=\"html ui top attached segment tryit-container \" >\n"+
                ...
                "\t<div class=\"ui top attached label\">\n"+
                    `\t\t<button id="tryit${i}-run" class="ui  ${i>1?'yellow':'green'} right labeled icon button exec">
                  ...
                  " </button>\n"+
                  " &nbsp; <button id=\"ra_"+i+"\" class=\"circular ui icon button green floated right run_all\">"+
